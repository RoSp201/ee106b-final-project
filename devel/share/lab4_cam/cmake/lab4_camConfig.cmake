...
if("TRUE" STREQUAL "TRUE")
  set(lab4_cam_SOURCE_PREFIX /home/cc/ee106b/sp17/class/ee106b-aah/final_project/src/lab4_cam)
  set(lab4_cam_DEVEL_PREFIX /home/cc/ee106b/sp17/class/ee106b-aah/final_project/devel)
  set(lab4_cam_INSTALL_PREFIX "")
  set(lab4_cam_PREFIX ${lab4_cam_DEVEL_PREFIX})
else()
  set(lab4_cam_SOURCE_PREFIX "")
  set(lab4_cam_DEVEL_PREFIX "")
  set(lab4_cam_INSTALL_PREFIX /home/cc/ee106b/sp17/class/ee106b-aah/final_project/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab4_cam' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'abuchan <abuchan@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab4_cam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106b/sp17/class/ee106b-aah/final_project/src/lab4_cam/${idir}'.  Ask the maintainer 'abuchan <abuchan@todo.todo>' to fix it.")
    endif()
...
set(lab4_cam_EXPORTED_TARGETS "lab4_cam_generate_messages_cpp;lab4_cam_generate_messages_lisp;lab4_cam_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${lab4_cam_dep}_FOUND)
      find_package(${lab4_cam_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lab4_cam_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND lab4_cam_EXPORTED_TARGETS ${${lab4_cam_dep}_EXPORTED_TARGETS})
endforeach()
