...
if("TRUE" STREQUAL "TRUE")
  set(baxter_maintenance_msgs_SOURCE_PREFIX /home/cc/ee106b/sp17/class/ee106b-aah/final_project/src/baxter_common/baxter_maintenance_msgs)
  set(baxter_maintenance_msgs_DEVEL_PREFIX /home/cc/ee106b/sp17/class/ee106b-aah/final_project/devel)
  ...
  set(baxter_maintenance_msgs_INSTALL_PREFIX /home/cc/ee106b/sp17/class/ee106b-aah/final_project/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_maintenance_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_maintenance_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106b/sp17/class/ee106b-aah/final_project/src/baxter_common/baxter_maintenance_msgs/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
...
set(baxter_maintenance_msgs_EXPORTED_TARGETS "baxter_maintenance_msgs_generate_messages_cpp;baxter_maintenance_msgs_generate_messages_lisp;baxter_maintenance_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${baxter_maintenance_msgs_dep}_FOUND)
      find_package(${baxter_maintenance_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${baxter_maintenance_msgs_dep} REQUIRED ${depend_list})
  endif()
